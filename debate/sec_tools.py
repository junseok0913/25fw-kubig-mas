"""SEC filing tools (debate-local).

Implements minimal SEC EDGAR access as LangChain tools so experts can tool-call
filings during debate. Uses on-disk caching under `cache/{BRIEFING_DATE}/sec/`.
"""
