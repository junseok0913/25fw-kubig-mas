...
Important:
- Keep the original wording/content; only add XML tags for structure.
- Templates using `.format(...)` must escape literal braces with `{{` / `}}`.
"""
...
# ============================================================
# 1) Expert persona prompts (ported, XML-structured)
# ============================================================
...
EXPERT_ROLE_DESCRIPTIONS: dict[str, str] = {
    "fundamental": FUNDAMENTAL_BLIND_PROMPT,
    "risk": RISK_BLIND_PROMPT,
    "growth": GROWTH_BLIND_PROMPT,
    "sentiment": SENTIMENT_BLIND_PROMPT,
}
...
EXPERT_USER_TEMPLATE_DEBATE_SENTIMENT = """\
<context>
